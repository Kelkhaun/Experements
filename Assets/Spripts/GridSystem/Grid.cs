...
public class Grid<TGridObject>
{
    ...
    public event EventHandler<OnGridObjectChangedEventArgs> GridObjectChanged;
        ...
        Func<Grid<TGridObject>, int, int, TGridObject> createGridObject)
    {
        ...
        if (_isDebug)
        {
            ...
            OnGridObjectChanged += (i, i1) =>  debugTextArray[i, i1].text = _gridArray[i, i1]?.ToString();
        }
    }
    ...
    public void InvokeGridObjectChanged(int x, int y)
    {
        OnGridObjectChanged?.Invoke(x,y);
    }
